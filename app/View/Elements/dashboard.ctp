...
<?php   } else {?>
	<!--<div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Profile",true),"/myprofile") ?></div>-->
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("All Music",true),"/") ?></div>
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Your Music",true),"/your_music") ?></div>
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Upload A Song",true),"/your_music/upload") ?></div>
<?php   } ?>
